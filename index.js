...
button3.addEventListener('click', function(){
    ...
    ta_genbun = ta_genbun.replace('Mr.','Mr').replace('U.S.A','USA').replace('Mrs.','Mrs').replace('Dr.','Dr').replace('Ms.','Ms').replace('U.K.','UK').replace('B.C.','BC').replace('A.D.','AD').replace('St.','St').replace('U.S.','US').replace('Ave.','Ave').replace('Co.','Co').replace('Ltd.','Ltd').replace('co.','co').replace('ltd.','ltd').replace('etc.','etc').replace('i.e.','ie').replace('e.g.','eg').replace('Inc.','inc').replace('Rd.','Rd').replace('Prof.','Prof').replace('Ph.D.','PhD').replace('vs.','vs').replace('VS.','VS').replace('Vs.','Vs');
